...
import { Heart, Lock, Mail, User, Eye, EyeOff, Loader2 } from 'lucide-react';
      ...
      <div className="max-w-md w-full glass-panel rounded-3xl p-8 border border-neutral-850 shadow-2xl relative z-10 transition-all duration-300">
        <div className="text-center space-y-3 mb-8">
          ...
          <h2 className="text-2xl font-extrabold text-neutral-100 uppercase tracking-wide">
            Join Red<span className="text-blood-500">Hope</span>
          </h2>
          <p className="text-xs text-neutral-400">Sign up in seconds to start requests or offer blood donations</p>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-neutral-850 text-center">
          <p className="text-xs text-neutral-400">
            ...
            <Link to="/login" className="text-blood-400 hover:text-blood-300 font-bold transition-colors">
              Log In
            </Link>
          </p>
        </div>
